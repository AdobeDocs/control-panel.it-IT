...
product: campaign
solution: Campaign
title: Il Pannello di controllo consente di svolgere in modo più efficiente le attività di amministrazione del prodotto Adobe Campaign Standard e/o Classic.
...
Il Pannello di controllo consente di svolgere in modo più efficiente le attività di amministrazione del prodotto Adobe Campaign Standard e/o Classic, permettendoti di gestire le impostazioni e tenere traccia dell’utilizzo di ciascuna istanza. L’interfaccia intuitiva consente di monitorare facilmente l’utilizzo delle risorse chiave, nonché di eseguire attività amministrative come l’inserimento di indirizzi IP nell’elenco Consentiti, il monitoraggio dell’archiviazione SFTP, la gestione delle chiavi e altro ancora.
